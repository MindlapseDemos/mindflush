...
CXXFLAGS = -O3 -ansi -pedantic -Wall -Isrc -I$(eng_dir)/src `$(eng_dir)/3dengfx-config --cflags`
LIBS = `$(eng_dir)/3dengfx-config --libs-no-3dengfx` `sdl-config --libs` -lvorbisfile
